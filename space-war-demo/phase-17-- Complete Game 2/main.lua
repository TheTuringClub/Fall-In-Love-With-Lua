...
function love.load()
    ...
    --smallFont = love.graphics.newFont('font.ttf', 7)
	--mediumFont = love.graphics.newFont('flappy.ttf', 14)
    Text_Font = love.graphics.newFont('flappy.ttf', 28)
...
function love.draw()
	...
	--print score
	love.graphics.print("Score: "..score, love.graphics.getWidth()/2-50, love.graphics.getHeight()-30)

	-- check if game over?
	if game_over then
		love.graphics.setColor(255,0,0)
		love.graphics.print("Game Over!",love.graphics.getWidth()/2-65,love.graphics.getHeight()/2-30)
		love.graphics.print("Press r to restart or esc to exit.",love.graphics.getWidth()/2-226,love.graphics.getHeight()/2)
		return
	elseif game_won then
		love.graphics.setColor(0,0,255)
		love.graphics.print("You Won.",love.graphics.getWidth()/2-55,love.graphics.getHeight()/2-30)
		love.graphics.print("Press r to restart or esc to exit.",love.graphics.getWidth()/2-226,love.graphics.getHeight()/2)
	end
